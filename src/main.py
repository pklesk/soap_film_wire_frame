...
APPROACHES_CONTRACTION = { # approaches for contraction iteration
    ...
    sfwf.sfwf_contraction_cuda_large_atomicmaxnew.__name__: (True, sfwf.sfwf_contraction_cuda_large_atomicmaxnew, DEFAULT_REPETITIONS, {"lazy_stop_check": sfwf.DEFAULT_LAZY_STOP_CHECK, "tpb_side": sfwf.DEFAULT_TPB_SIDE}),
    ...
    sfwf.sfwf_contraction_cuda_large_hreducemaxnew.__name__: (True, sfwf.sfwf_contraction_cuda_large_hreducemaxnew, DEFAULT_REPETITIONS, {"lazy_stop_check": sfwf.DEFAULT_LAZY_STOP_CHECK, "tpb_side": sfwf.DEFAULT_TPB_SIDE, "tpb_reduce": sfwf.DEFAULT_TPB}),    
