...
APPROACHES_CONTRACTION = { # approaches for contraction iteration
    ...
    sfwf.sfwf_contraction_cuda_large_atomicmaxnew.__name__: (True, sfwf.sfwf_contraction_cuda_large_atomicmax, DEFAULT_REPETITIONS, {"lazy_stop_check": sfwf.DEFAULT_LAZY_STOP_CHECK, "tpb_side": sfwf.DEFAULT_TPB_SIDE}),
