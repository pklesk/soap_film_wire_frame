...
APPROACHES_CONTRACTION = { # approaches for contraction iteration
    ...
    sfwf.sfwf_contraction_cuda_large_gridsyncnew.__name__: (False, sfwf.sfwf_contraction_cuda_large_gridsyncnew, DEFAULT_REPETITIONS, {"tpb_side": sfwf.DEFAULT_TPB_SIDE})    
    }
