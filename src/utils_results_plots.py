...
if __name__ == "__main__":
    ...
    series = [
        ...
        {
            "sfwf_contraction_cuda_large_atomicmax": [0.025, 0.160, 0.739, 0.722, 5.552],
            "sfwf_contraction_cuda_large_atomicmaxglosten": [0.025, 0.161, 0.730, 0.724, 5.718],
            "sfwf_contraction_cuda_large_hreducemax": [0.016, 0.101, 0.456, 0.448, 5.323],
            "sfwf_contraction_cuda_large_hreducemaxgs": [0.016, 0.102, 0.460, 0.451, 5.337],
            "sfwf_contraction_cuda_large_gridsync": [0.006, 0.042, 0.351, 0.960, 12.152]            
        }
    ]
